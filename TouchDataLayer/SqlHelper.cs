...
namespace TouchDataLayer
{
    ...
    public abstract class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        //public static readonly string connectionString = "Data Source="+ AppDomain.CurrentDomain.BaseDirectory + @"\App_Data\TouchPlatform.mdf;";
        ...
        public static string connectionString
        {
            get
            {
                ...
                {
                    // 读取配置文件，获取数据库连接字符串。                    
                    _connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["default"].ToString();
                }
        ...
        public static SqlDataReader dataReader(string sql, SqlParameter[] commandParameters = null)
        {
            return ExecuteReader(connectionString, CommandType.Text, sql, commandParameters);
        }

        public static int excuteSql(string cmdText, SqlParameter[] commandParameters = null)
        {
            return ExecteNonQuery(SqlHelper.connectionString, CommandType.Text, cmdText, commandParameters);
        }
        #endregion
    }
}